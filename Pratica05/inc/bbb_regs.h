 ...
 *       Filename:  bb_regs
 *
 *    Description:  Definições de registradores para BeagleBone Black
 *
 *        Version:  1.1
 *        Created:  23/05/2018 17:47:17
 *       Revision:  Atualizado em 2025
 *       Compiler:  gcc
 *
...
/* Clock Modules */
#define CM_PER_GPIO0_CLKCTRL  0x44E000AC  // Adicionado para GPIO0 (geralmente mesmo offset que GPIO1)
#define CM_PER_GPIO1_CLKCTRL  0x44E000AC
#define CM_PER_GPIO2_CLKCTRL  0x44E000B0

#define CM_WKUP_GPIO0_CLKCTRL 0x44E004BC  // Clock Wakeup para GPIO0
...
/* Led externo prática 5 */
#define CM_PER_GPMC_OEN_REN_REGS 0x44E10894
#define CM_PER_GPMC_WEn_REGS     0x44E10898
#define CM_PER_GPMC_CLK_REGS     0x44E1088C

/* GPIO0 */
#define GPIO0_OE             0x44E070134
#define GPIO0_DATAIN         0x44E070138
#define GPIO0_CLEARDATAOUT   0x44E070190
#define GPIO0_SETDATAOUT     0x44E070194
#define GPIO0_RISINGDETECT   0x44E070148
#define GPIO0_FALLINGDETECT  0x44E07014C
#define GPIO0_IRQSTATUS_0    0x44E07002C
#define GPIO0_IRQSTATUS_SET_0 0x44E070034
#define GPIO0_IRQSTATUS_1    0x44E070030
#define GPIO0_IRQSTATUS_SET_1 0x44E070038
...
#define GPIO2_IRQSTATUS_SET_0 0x4814C034
#define GPIO2_OE             0x4814C134
#define GPIO2_DATAIN         0x4814C138
#define GPIO2_RISINGDETECT   0x4814C148
#define GPIO2_CLEARDATAOUT   0x4814C190
#define GPIO2_SETDATAOUT     0x4814C194
#define GPIO2_FALLINGDETECT  0x4814C14C
#define GPIO2_IRQSTATUS_1    0x4814C030
#define GPIO2_IRQSTATUS_SET_1 0x4814C038
